...
class Lidar():
    ...
    def projection_pts_on_cam(self, csv_data, cam_point=None):
        ...
        #print(alpha, betta, gamma, cam_pos)
        #print("cam_point 2", cam_point)
...
class SMI_calculations:
    ...
    def power(self):
        #SMI_point = self.SMI_point_calculations()
    ...
    def SMI_point_calculations(self, ):
        ...
        for i in range(5, len(self.local_camera.image_files) - 150-1):
            ...
            if next_SMI > cur_SMI:
                ...
                if next_SMI < cur_SMI + self.delta:
                    print("SMI calc for ", i, "file =", cur_SMI)
                    print("SMI pts  for ", i, "file =", cur_points)
                    break
    ...
    def SMI_Visualization(self, SMI_point = None, color = "Height"):
        if SMI_point is None:
            SMI_point = self.local_camera.camera_rotation_angles + self.local_lidar.lidar_pos_in_cam_sys
        for i in range(5, len(self.local_lidar.lidar_data)-150):
